...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("rolesDemoSSD.Data.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Genre = "War",
                            MovieName = "La Grande Illusion",
                            PosterSource = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8NFGY_qLiXHGNgA0fXo59tn4iapzfYwQNiQ&usqp=CAU",
                            ReleaseDate = "1937"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("rolesDemoSSD.Data.Review", b =>
                {
                    ...
                    b.HasIndex("MovieVMMovieID");

                    b.HasIndex("UserVMEmail");
            ...
            modelBuilder.Entity("rolesDemoSSD.Data.Review", b =>
                {
                    b.HasOne("rolesDemoSSD.ViewModels.MovieVM", "MovieVM")
                        .WithMany()
                        .HasForeignKey("MovieVMMovieID");

                    b.HasOne("rolesDemoSSD.ViewModels.UserVM", "UserVM")
                        .WithMany()
                        .HasForeignKey("UserVMEmail");

                    b.Navigation("MovieVM");
